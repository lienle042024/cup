...
void _cups_debug_printf(const char *format, /* I - Printf-style format string */
...
void _cups_debug_puts(const char *s) /* I - String to output */
{
  struct timeval curtime; /* Current time */
  char buffer[2048];      /* Output buffer */
  ssize_t bytes;          /* Number of bytes in buffer */
...
void _cups_debug_set(const char *logfile, /* I - Log file or NULL */

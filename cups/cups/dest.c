...
void _cupsAppleSetDefaultPaperID(
...
void _cupsAppleSetDefaultPrinter(
...
void _cupsAppleSetUseLastPrinter(
...
void cupsFreeDests(int num_dests,      /* I - Number of destinations */
...
void cupsSetDests(int num_dests,      /* I - Number of destinations */
                  cups_dest_t *dests) /* I - Destinations */
{

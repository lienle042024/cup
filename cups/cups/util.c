...
{
  return (cupsCancelJob2(CUPS_HTTP_DEFAULT, name, job_id, 0) < IPP_STATUS_REDIRECTION_OTHER_SITE);
}
...
void cupsFreeJobs(int num_jobs,     /* I - Number of jobs */
...
cancel_job:
  ...
  cancel_message = cg->last_status_message ? _cupsStrRetain(cg->last_status_message) : NULL;

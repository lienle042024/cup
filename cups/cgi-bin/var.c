...
void cgiSetArray(const char *name,  /* I - Name of variable */
                 int element,       /* I - Element number (0 to N) */
...
void cgiSetCookie(const char *name,   /* I - Name */
...
void cgiSetSize(const char *name, /* I - Name of variable */
...
void cgiSetVariable(const char *name,  /* I - Name of variable */
                    const char *value) /* I - Value of variable */
{
  int i;           /* Looping var */
  _cgi_var_t *var; /* Returned variable */

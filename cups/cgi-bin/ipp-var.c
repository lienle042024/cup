...
void cgiGetAttributes(ipp_t *request,   /* I - IPP request */
...
void cgiMoveJobs(http_t *http,     /* I - Connection to server */
...
void cgiPrintCommand(http_t *http,        /* I - Connection to server */
...
void cgiPrintTestPage(http_t *http,     /* I - Connection to server */
...
void cgiShowIPPError(const char *message) /* I - Contextual message */
{
...
void cgiShowJobs(http_t *http,     /* I - Connection to server */

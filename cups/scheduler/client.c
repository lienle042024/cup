...
void cupsdAcceptClient(cupsd_listener_t *lis) /* I - Listener socket */
{
...
void cupsdReadClient(cupsd_client_t *con) /* I - Client to read from */
{
...
void cupsdWriteClient(cupsd_client_t *con) /* I - Client connection */
{

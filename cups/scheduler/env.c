...
void cupsdSetEnv(const char *name,  /* I - Name of variable */
...
void cupsdSetEnvf(const char *name,  /* I - Name of variable */
...
void cupsdUpdateEnv(void)
{
  /*
   * Set common variables...
   */

#define set_if_undefined(name, value) \
  if (find_env(name) < 0)             \
  cupsdSetEnv(name, value)

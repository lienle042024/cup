...
void cupsdRegisterPrinter(cupsd_printer_t *p) /* I - Printer */
{
...
void cupsdStartBrowsing(void)
{
  ...
  if (BrowseLocalProtocols & BROWSE_DNSSD)
  {
    ...
    if ((error = DNSServiceCreateConnection(&DNSSDMaster)) != kDNSServiceErr_NoError)
    {
...
void cupsdUpdateDNSSDName(void)
{

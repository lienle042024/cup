...
void cupsdAddLocation(cupsd_location_t *loc) /* I - Location to add */
{
  /*
...
void cupsdAddName(cupsd_location_t *loc, /* I - Location to add to */
...
void cupsdAuthorize(cupsd_client_t *con) /* I - Client connection */
{
...
void cupsdDeleteAllLocations(void)
{
  /*

...
void cupsdClearString(char **s) /* O - String value */
{
  if (s && *s)
  {
    free(*s);
...
void cupsdFreeStrings(cups_array_t **a) /* IO - String array */
{
  if (*a)
  {
    cupsArrayDelete(*a);
...
void cupsdSetString(char **s,      /* O - New string */
...
void cupsdSetStringf(char **s,      /* O - New string */

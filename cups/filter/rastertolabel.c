...
void OutputLine(ppd_file_t *ppd,             /* I - PPD file */
                cups_page_header2_t *header, /* I - Page header */
...
void PCLCompress(unsigned char *line, /* I - Line to compress */
...
void ZPLCompress(unsigned char repeat_char, /* I - Character to repeat */
